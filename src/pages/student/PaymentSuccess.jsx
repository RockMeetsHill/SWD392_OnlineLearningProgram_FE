...
const PaymentSuccess = () => {
  ...
  return (
    <Box bg={bgColor} minH="100vh" position="relative" overflow="hidden">
        ...
        <VStack spacing={12} align="stretch">
          ...
          <VStack spacing={6} textAlign="center">
            ...
            <Text fontSize="lg" color={mutedColor} maxW="500px">
              We've received your payment. Your course has been activated and is
      ...
      {/* Footer */}
      <Box py={10} borderTop="1px" borderColor={borderColor} textAlign="center">
        <Text fontSize="sm" color={mutedColor}>
